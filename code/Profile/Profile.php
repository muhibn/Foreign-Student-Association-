...
<div class="container">
<img src="pic\Stars-wallpapers-HD-free-download.jpg"  width="70%" height="50%">
 <div class="centered">Profile Page</div>
</div>
 <br>
    <?php  
session_start();
...
<div  id="Profile_header">
    ...
    <a href="../Post\input post.html">new post </a>  &nbsp &nbsp
    <a href="../Document\document.html">post the  file</a> &nbsp &nbsp
    <a href="logout php.php">longout</a> <br> 
</div>
...
<?php
   ...
   $q="Select PUID,IMAGE,TEXT,PDATA,SECTION,SUID FROM   post where SUID=$suids ";
