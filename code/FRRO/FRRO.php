...
<div class="container">
 <img  src="pic\pexels-tima-miroshnichenko-7009468.jpg"  width="70%" height="50%" >
 <div class="centered">F.R.R.O Page</div>
</div>
<br>
 <?php
   $con=mysqli_connect('localhost','root');
   mysqli_select_db($con,'FSA');
   $q="Select PUID,IMAGE,TEXT,PDATA,SECTION,SUID FROM   post where  SECTION='FRRO'";
